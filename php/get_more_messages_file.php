...
{
    public function retrieve_next_messages($channel_id,$count,$total_count){
        include ("connect.php");
        $temp_time="";
        $temp_time_month="";
        $counter_today=0;
       ...
       // $check_count=$count;
        ...
        while($row=$result_set->fetch_array(MYSQLI_ASSOC)){
            //echo "<br>";
            $attach_increment=$attach_increment+1;
            ...
            if($temp_time==$formated_time_am_pm and $row["user_id"]==$temp_user_id) {
               // $attach_div=$attach_div."<div class=\"message_display_sub the_whole_message_sub \" > <div class=\"message_sub\" id=\"".htmlspecialchars($row["message_id"])."_div\">" .htmlspecialchars($row["message"]) ." <br> ";
                ...
                if($row["message_type"]=="codesnip"){
                    ...
                    $attach_div=$attach_div."<div class=\"message_display_sub the_whole_message_sub\" > <div class=\"message_sub\" id=\"" . htmlspecialchars($row["message_id"]) . "_div\"><pre><code>" . htmlspecialchars($row["message"]) . " </code></pre><br> ";
                    // echo "<div class=\"clear\"></div>";
                }
                if($row["message_type"]=="image_link" ){

                    $attach_div=$attach_div."<div class=\"message_display_sub the_whole_message_sub\" > <div class=\"message_sub\" id=\"" . htmlspecialchars($row["message_id"]) . "_div\"><a href=\"" . htmlspecialchars($row["message"]) ." \">" . htmlspecialchars($row["message"]) . "</a><br><img height=\"200\" width=\"200\" src=\"" . htmlspecialchars($row["message"]) . "\"\><br> ";
                    //echo "<div class=\"clear\"></div>";

                }
                if($row["message_type"]=="picture"){

                    $attach_div=$attach_div."<div class=\"message_display_sub the_whole_message_sub\" > <div class=\"message_sub\" id=\"" . htmlspecialchars($row["message_id"]) . "_div\"><img height=\"200\" width=\"200\" src=\"" . htmlspecialchars($row["message"]) . "\"\><br> ";
                    //echo "<div class=\"clear\"></div>";
             ...
             /*   if($check_br==1)
                ...
                if($row["message_type"]=="picture" ){
                    ...
                    $attach_div=$attach_div. "<div class=\"message_display \" id=\"" . htmlspecialchars($row["message_id"]) . "_div\"><div class=\"only_message\"><img height=\"200\" width=\"200\" src=\"" . htmlspecialchars($row["message"]) . "\"\>  </div>  ";
                    // echo "<div class=\"clear\"></div>";
                }
                if($row["message_type"]=="image_link"){


                    $attach_div=$attach_div. "<div class=\"message_display \" id=\"" . htmlspecialchars($row["message_id"]) . "_div\"><div class=\"only_message\"><a href=\"" . htmlspecialchars($row["message"]) ." \">" . htmlspecialchars($row["message"]) . "</a><br><img height=\"200\" width=\"200\" src=\"" . htmlspecialchars($row["message"]) . "\"\>  </div>  ";
