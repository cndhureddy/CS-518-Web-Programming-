    ...
    if($channel_id) {
        ...
        if ($result_user_id->num_rows > 0) {
            ...
            while ($row_user_id = $result_user_id->fetch_assoc()) {
                ...
                {
                    echo "<form action=\"removemember_admin.php\" method=\"post\"><input type=\"hidden\" name=\"user_id\" value=\"$user_id\" ><input type=\"hidden\" name=\"channel_id\" value=\"$channel_id\" ><tr><td>" . htmlspecialchars($full_name) . "</td><td><input type=\"submit\" value=\"remove member\"/></td></tr></form>";
                }else {
                    $count=0;

                    echo "<form action=\"addmember_admin.php\" method=\"post\"><input type=\"hidden\" name=\"user_id\" value=\"$user_id\" ><input type=\"hidden\" name=\"channel_id\" value=\"$channel_id\" ><tr><td>" . htmlspecialchars($full_name) . "</td><td><input type=\"submit\" value=\"invite member\"/></td></tr></form>";
                }
