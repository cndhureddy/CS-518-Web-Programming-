...
(237, 1, 1, 'codesnip_value', '2017-11-20 04:34:43', 'False', 'image_link'),
...
(255, 1, 1, 'if(isset($_POST[\"codesnip_value\"])){\r\n\r\n    $channel_id=$_POST[\"channel_id\"];\r\n    $user_id=$_POST[\"user_id\"];\r\n    $message=$_POST[\"codesnip_value\"];\r\n    $message_type=$_POST[\"message_type\"];\r\n    $return_value=$message_posting->post_message($channel_id,$user_id,$message,$message_type);\r\n    echo $return_value;\r\n    if($return_value==1){\r\n        header(\"location: home.php?$parameter#test\");\r\n\r\n    }\r\n\r\n\r\n\r\n\r\n\r\n}', '2017-11-20 04:52:22', 'False', 'image_link'),
